...
LOCAL_DE = PROJECT_ROOT / "local_deep_research"
...
def clean_embedding_cache(mcp_tool_map):
    ...
    cache_path = LOCAL_DE / "cache_data" / "tool_desc_embedding.pkl"
...
def check_template_system():
    ...
    template_path = LOCAL_DE / "tools" / "template" / "clinical_templates.pkl"
